<div class="m-t-15">
    <div class="text-end btn-mb">
       <button class="btn btn-secondary js-save-button js-create-fel3" disabled="disabled">
        ...
        <button class="btn btn-primary js-create-fel3 js-save-button m-r-20" disabled="disabled" data-status="publish">
                           <span class="text-button loader-box loader-box-custom" style="height: 21px">
