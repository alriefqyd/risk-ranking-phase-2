        ...
        <table class="table table-striped text-center">
            ...
            @foreach($project->getCostBenefit(false) as $bc)
                <tr data-id="1">
                    ...
                    <td>
                        <input type="number" name="initial_and_sustaining_capex[]" value="{{$bc['initial_and_sustaining_capex']}}" class="form-control js-cost-benefit js-initial-and-sustaining">
                    </td>
                    <td>
                        <input type="number" name="additional_revenue[]" value="{{$bc['additional_revenue']}}" class="form-control js-cost-benefit js-additional-revenue">
                    </td>
                    <td>
                        <input type="number" name="increment_operating_cost[]" value="{{$bc['increment_operating_cost']}}" class="form-control js-cost-benefit js-increment-operating-cost">
                    </td>
                    <td>
                        <input type="number" name="cost_savings[]" value="{{$bc['cost_savings']}}" class="form-control js-cost-benefit js-cost-savings">
                    </td>
                    <td>
                        <input type="number" name="net_incremental_benefits[]" readonly="true" value="{{$bc['net_incremental_benefits']}}" class="form-control js-cost-benefit js-net-incremental-benefits">
                    </td>
                </tr>
            @endforeach
            </tbody>
