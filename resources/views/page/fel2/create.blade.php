<form method="post" action="/fel2/"
    ...
    <div class="card-footer">
        <button class="btn btn-secondary js-save-button js-create-fel2" disabled="disabled">
        ...
        <button class="btn btn-primary js-save-button js-create-fel2" disabled="disabled" data-status="publish">
           <span class="text-button loader-box loader-box-custom"  style="height: 21px">
