<form method="post" action="/fel2/{{$project->id}}/"
    ...
    <div class="card-footer">
        <button class="btn btn-secondary js-save-button js-create-fel2">
        ...
        <button class="btn btn-primary js-save-button js-create-fel2" data-status="publish">
           <span class="text-button loader-box loader-box-custom"  style="height: 21px">
