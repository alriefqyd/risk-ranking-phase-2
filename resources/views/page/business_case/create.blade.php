<form method="post" action="/business-case/"
    ...
    <div class="card-footer">
        <button class="btn btn-secondary js-create-bc" disabled="disabled">
        ...
        <button class="btn btn-primary js-create-bc" data-status="publish" disabled="disabled">
           <span class="text-button loader-box loader-box-custom"  style="height: 21px">
