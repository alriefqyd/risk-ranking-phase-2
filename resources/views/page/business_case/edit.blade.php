<form method="post" action="/business-case/{{$project->id}}/"
    ...
    <div class="card-footer">
        <button class="btn btn-secondary js-save-button js-create-bc float-end m-5">
        ...
        <button class="btn btn-primary js-save-button js-create-bc float-end m-5" data-status="publish">
           <span class="text-button loader-box loader-box-custom"  style="height: 21px">
