<header class="main-nav">
    <div class="sidebar-user text-center"><a class="setting-primary"><i data-feather="settings"></i></a><img class="img-90 rounded-circle" src="{{asset('assets/images/dashboard/1.png')}}" alt="">
